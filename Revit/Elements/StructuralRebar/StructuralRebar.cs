...
using Dynamo.Graph.Nodes; // Reference from DynamoVisualProgramming.Core at NuGet Package
...
namespace DynamoLabCTS.Revit.Elements
{
    /// <summary>
    ...
    public class StructuralRebar
    {
        ...
        public static Rebar CreateRebar_ZTN(global::Revit.Elements.Element columnDynamo, RebarBarType barType, RebarHookType hookType)
        {
            ...
            Rebar rebar = Rebar.CreateFromCurves(dynamoDocument, Autodesk.Revit.DB.Structure.RebarStyle.Standard, barType, hookType, hookType, column, origin, curves, RebarHookOrientation.Right, RebarHookOrientation.Left, true, true);
        ...
        public static Rebar CreateRebarFromCurve_ZTN(RebarStyle style, RebarBarType barType, RebarHookType startHookType, RebarHookType endHookType,
        ...
        /// <returns name="Rebar">new created Rebar</returns> 
        [NodeCategory("Create")]  //works because we addusing Dynamo.Graph.Nodes; Reference from DynamoVisualProgramming.Core at NuGet Package
        public static Rebar CreateRebarFromRebarShape_ZTN(RebarShape rebarShape, RebarBarType barType, global::Revit.Elements.Element dynamoHost,
        ...
        */
        ...
        [MultiReturn(new[] { "startRebarHookOrientation", "endRebarHookOrientation", "startRebarHookType", "startRebarHookTypeName",
            "endRebarHookType", "endRebarHookTypeName","rebarShape", "rebarShapeName", "rebarBarType", "rebarBarTypeName" ,"rebarStyle"})]
        public static object GetRebarProperties_ZTN(global::Revit.Elements.Element dynamoRebar)
        {
            ...
            ////0 for the start hook, 1 for the end hook.
            Autodesk.Revit.DB.Structure.RebarHookType startRebarHookType = (RebarHookType)doc.GetElement(revitRebar.GetHookTypeId(0));
            ...
            Autodesk.Revit.DB.Structure.RebarHookType endRebarHookType = (RebarHookType)doc.GetElement(revitRebar.GetHookTypeId(1));
            ...
            Autodesk.Revit.DB.Structure.RebarShape rebarShape = (RebarShape)doc.GetElement(revitRebar.GetShapeId());
            string rebarShapeName = rebarShape.Name;
            ...
            Autodesk.Revit.DB.Structure.RebarBarType rebarBarType = (RebarBarType)doc.GetElement(revitRebar.GetTypeId());
            string rebarBartypeName = rebarBarType.Name;
